    ...
    handleClick = (e) => 
    {
        ...
        this.setState(()=>{
            ...
            if(launch!== "" || land!=="" || year !== undefined)
            {
                ...
                axios.get(`https://api.spacexdata.com/v3/launches?limit=100${launch!==""?`&launch_success=${launch}`:""}${land!==""?`&land_success=${land}`:""}${year!==undefined?`&launch_year=${year}`:""}`)
                .then(res => {
    ...
    render()
        {
            ...
            return(
                        ...
                        <aside className="filter-area">
                                <div style={{padding:"12px",fontSize:"12px"}}><h2>Filters</h2></div>
